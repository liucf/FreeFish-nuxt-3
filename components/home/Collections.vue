  ...
  <section aria-labelledby="collections-heading">
    <div class="mx-auto">
      <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
        ...
        <div
          class="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:gap-y-6 lg:space-y-0"
        >
          <div
          ...
          >
            ...
            >
              <img
                :src="getImgPath(collection?.thumb)"
                :alt="collection.name"
...
function getImgPath(imgName: string): string {
  ...
  return imgName
    ? config.public.BASE_URL_SERVER + "/storage/subcategory/" + imgName
    : "logo.png";
}
</script>
