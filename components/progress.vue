    ...
    <nav class="mx-auto max-w-7xl" aria-label="Progress">
      ...
      >
        ...
        >
          ...
          >
            <a
              v-if="stepStatus[stepIdx] === 'complete'"
              :href="step.href"
              class="group"
            >
              <span
            ...
            <a
              v-else-if="stepStatus[stepIdx] === 'current'"
              :href="step.href"
              aria-current="step"
            >
              <span
...
const steps = [
  {
    id: "01",
    name: "Shipped",
    description: "Seller ship the item by input the tracking number.",
    href: "#",
    status: "complete",
  },
  {
    id: "02",
    name: "Deliveried",
    description: "The item is deliveried to the buyer.",
    href: "#",
    status: "current",
  },
  {
    id: "03",
    name: "Review",
    description: "The buyer and seller review each other.",
    href: "#",
    status: "upcoming",
  },
];
