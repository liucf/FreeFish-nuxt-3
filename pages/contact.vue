    ...
    <div class="bg-white">
        ...
        <div class="bg-warm-gray-50">
            <div class="py-24 lg:py-32">
                <div class="relative z-10 mx-auto max-w-7xl pl-4 pr-8 sm:px-6 lg:px-8">
                    <h1 class="text-4xl font-bold tracking-tight text-warm-gray-900 sm:text-5xl lg:text-6xl">Get in
                        touch</h1>
                    <p class="mt-6 max-w-3xl text-xl text-warm-gray-500">This is a project for COMPX576 By Chengfang Liu.
                    </p>
                </div>
            </div>
        </div>
        ...
        <section class="relative bg-white" aria-labelledby="contact-heading">
            ...
            <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
                <svg class="absolute top-0 right-0 z-0 -translate-y-16 translate-x-1/2 transform sm:translate-x-1/4 md:-translate-y-24 lg:-translate-y-72"
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="relative bg-white shadow-xl">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3">
                        <!-- Contact information -->
                        <div
                            class="relative overflow-hidden bg-gradient-to-b from-lightning-yellow-400 to-lightning-yellow-600 py-10 px-6 sm:px-10 xl:p-12">
                            ...
                            <p class="mt-6 max-w-3xl text-base text-teal-50">Fell free to contact me any time.</p>
                        ...
                        <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                            ...
                            <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                ...
                                <div class="sm:col-span-2 sm:flex sm:justify-end">
                                    <button type="submit"
                                        class="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-primary px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-lightning-yellow-600 focus:outline-none focus:ring-2 focus:ring-lightning-yellow-500 focus:ring-offset-2 sm:w-auto">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <!-- <section aria-labelledby="offices-heading">
            <div class="mx-auto max-w-7xl py-24 px-6 sm:py-32 lg:px-8">
                ...
                <p class="mt-6 max-w-3xl text-lg text-warm-gray-500">Varius facilisi mauris sed sit. Non sed et duis dui
