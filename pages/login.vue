      ...
      <div class="bg-white px-4 py-8 shadow sm:rounded-lg sm:px-10">
        ...
        >
          ...
          <div>
            <button
              type="submit"
              class="flex w-full justify-center rounded-md border border-transparent bg-primary px-4 py-2 text-sm font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-lightning-yellow-500 focus:ring-offset-2"
              :disabled="isLoading"
              :class="!isLoading ? 'hover:bg-lightning-yellow-500' : ''"
            >
              <svg
                v-if="isLoading"
